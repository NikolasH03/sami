...
public class EstadoPatrullaEnemigo : EstadoBase
{
    ...
    public EstadoPatrullaEnemigo(Enemigo enemigo, Animator animator, NavMeshAgent agente, float radioDePatrulla, float tiempoEspera) : base(enemigo, animator)
    {
        this.agent = agente;
